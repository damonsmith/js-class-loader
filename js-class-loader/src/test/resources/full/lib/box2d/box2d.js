...
b2Mat22.prototype = 
{
	...
	Invert: function(out)
	{
		...
		//var B = new b2Mat22();
		var det = a * d - b * c;
		//box2d.b2Settings.b2Assert(det != 0.0);
		det = 1.0 / det;
...
b2Pair.prototype = 
{
	...
	initialize: function() {}};
b2Pair.b2_nullPair = box2d.b2Settings.USHRT_MAX;
b2Pair.b2_nullProxy = box2d.b2Settings.USHRT_MAX;
b2Pair.b2_tableCapacity = box2d.b2Settings.b2_maxPairs;
...
//public:
	initialize: function(){
		var i = 0;
		//box2d.b2Settings.b2Assert(b2Math.b2IsPowerOfTwo(b2Pair.b2_tableCapacity) == true);
		//box2d.b2Settings.b2Assert(b2Pair.b2_tableCapacity >= box2d.b2Settings.b2_maxPairs);
		this.m_hashTable = new Array(b2Pair.b2_tableCapacity);
		for (i = 0; i < b2Pair.b2_tableCapacity; ++i)
		{
			this.m_hashTable[i] = b2Pair.b2_nullPair;
		}
		this.m_pairs = new Array(box2d.b2Settings.b2_maxPairs);
		for (i = 0; i < box2d.b2Settings.b2_maxPairs; ++i)
		{
			this.m_pairs[i] = new b2Pair();
		}
		this.m_pairBuffer = new Array(box2d.b2Settings.b2_maxPairs);
		for (i = 0; i < box2d.b2Settings.b2_maxPairs; ++i)
		{
		...
		this.m_pairs[box2d.b2Settings.b2_maxPairs-1].next = b2Pair.b2_nullPair;
		this.m_pairCount = 0;
	},
	//~b2PairManager();
	...
	AddBufferedPair: function(proxyId1, proxyId2){
		//box2d.b2Settings.b2Assert(id1 != b2_nullProxy && id2 != b2_nullProxy);
		//box2d.b2Settings.b2Assert(this.m_pairBufferCount < b2_maxPairs);
		...
		if (pair.IsBuffered() == false)
		{
			...
			//box2d.b2Settings.b2Assert(pair.IsFinal() == false);
			...
			//box2d.b2Settings.b2Assert(this.m_pairBufferCount <= this.m_pairCount);
		}
	...
	RemoveBufferedPair: function(proxyId1, proxyId2){
		...
		if (pair.IsBuffered() == false)
		{
			...
			//box2d.b2Settings.b2Assert(pair.IsFinal() == true);
	...
	Commit: function(){
		...
		for (i = 0; i < this.m_pairBufferCount; ++i)
		{
			...
			//box2d.b2Settings.b2Assert(pair.IsBuffered());
			pair.ClearBuffered();

			//box2d.b2Settings.b2Assert(pair.proxyId1 < box2d.b2Settings.b2_maxProxies && pair.proxyId2 < box2d.b2Settings.b2_maxProxies);

			var proxy1 = proxies[ pair.proxyId1 ];
			var proxy2 = proxies[ pair.proxyId2 ];

			//box2d.b2Settings.b2Assert(proxy1.IsValid());
			//box2d.b2Settings.b2Assert(proxy2.IsValid());
			...
			{
				//box2d.b2Settings.b2Assert(this.m_broadPhase.TestOverlap(proxy1, proxy2) == true);
...
//private:
	...
	AddPair: function(proxyId1, proxyId2){
		...
		//box2d.b2Settings.b2Assert(this.m_pairCount < box2d.b2Settings.b2_maxPairs && this.m_freePair != b2_nullPair);
	...
	RemovePair: function(proxyId1, proxyId2){
		...
		//box2d.b2Settings.b2Assert(this.m_pairCount > 0);
		...
		//box2d.b2Settings.b2Assert(false);
		return null;
	},
	...
	FindHash: function(proxyId1, proxyId2, hash){
		...
		//box2d.b2Settings.b2Assert(index < b2_maxPairs);
...
//public:
	initialize: function(worldAABB, callback){
		...
		this.m_proxyPool = new Array(box2d.b2Settings.b2_maxPairs);
		this.m_bounds = new Array(2*box2d.b2Settings.b2_maxProxies);
		this.m_queryResults = new Array(box2d.b2Settings.b2_maxProxies);
		this.m_quantizationFactor = new b2Vec2();
		//

		//box2d.b2Settings.b2Assert(worldAABB.IsValid());
		var i = 0;
		...
		// query results
		for (i = 0; i < box2d.b2Settings.b2_maxProxies; i++){
		...
		for (i = 0; i < 2; i++){
			this.m_bounds[i] = new Array(2*box2d.b2Settings.b2_maxProxies);
			for (var j = 0; j < 2*box2d.b2Settings.b2_maxProxies; j++){
		...
		this.m_quantizationFactor.x = box2d.b2Settings.USHRT_MAX / dX;
		this.m_quantizationFactor.y = box2d.b2Settings.USHRT_MAX / dY;

		var tProxy;
		for (i = 0; i < box2d.b2Settings.b2_maxProxies - 1; ++i)
		{
			tProxy = new b2Proxy();
		...
		tProxy = new b2Proxy();
		this.m_proxyPool[box2d.b2Settings.b2_maxProxies-1] = tProxy;
	...
	CreateProxy: function(aabb, userData){
		...
		//box2d.b2Settings.b2Assert(this.m_proxyCount < b2_maxProxies);
		//box2d.b2Settings.b2Assert(this.m_freeProxy != b2Pair.b2_nullProxy);
		...
		//box2d.b2Settings.b2Assert(this.m_queryResultCount < box2d.b2Settings.b2_maxProxies);

		for (var i = 0; i < this.m_queryResultCount; ++i)
		{
			//box2d.b2Settings.b2Assert(this.m_queryResults[i] < b2_maxProxies);
			//box2d.b2Settings.b2Assert(this.m_proxyPool[this.m_queryResults[i]].IsValid());
	...
	DestroyProxy: function(proxyId){
		...
		//box2d.b2Settings.b2Assert(0 < this.m_proxyCount && this.m_proxyCount <= b2_maxProxies);

		var proxy = this.m_proxyPool[ proxyId ];
		//box2d.b2Settings.b2Assert(proxy.IsValid());
	...
	MoveProxy: function(proxyId, aabb){
		...
		if (proxyId == b2Pair.b2_nullProxy || box2d.b2Settings.b2_maxProxies <= proxyId)
		{
			//box2d.b2Settings.b2Assert(false);
			return;
		}
	...
	QueryAABB: function(aabb, userData, maxCount){
		...
		{
			//box2d.b2Settings.b2Assert(this.m_queryResults[i] < box2d.b2Settings.b2_maxProxies);
	...
	Validate: function(){
		...
		for (var axis = 0; axis < 2; ++axis)
		{
			...
			{
				var bound = bounds[i];
				//box2d.b2Settings.b2Assert(i == 0 || bounds[i-1].value <= bound->value);
				//box2d.b2Settings.b2Assert(bound->proxyId != b2_nullProxy);
				//box2d.b2Settings.b2Assert(this.m_proxyPool[bound->proxyId].IsValid());

				if (bound.IsLower() == true)
				{
					//box2d.b2Settings.b2Assert(this.m_proxyPool[bound.proxyId].lowerBounds[axis] == i);
					stabbingCount++;
				}
				else
				{
					//box2d.b2Settings.b2Assert(this.m_proxyPool[bound.proxyId].upperBounds[axis] == i);
					stabbingCount--;
				}

				//box2d.b2Settings.b2Assert(bound.stabbingCount == stabbingCount);
			}
		}
...
//private:
	...
	{
		//box2d.b2Settings.b2Assert(aabb.maxVertex.x > aabb.minVertex.x);
		//box2d.b2Settings.b2Assert(aabb.maxVertex.y > aabb.minVertex.y);
		...
		lowerValues[0] = /*uint*/(this.m_quantizationFactor.x * (minVertexX - this.m_worldAABB.minVertex.x)) & (box2d.b2Settings.USHRT_MAX - 1);
		upperValues[0] = (/*uint*/(this.m_quantizationFactor.x * (maxVertexX - this.m_worldAABB.minVertex.x))& 0x0000ffff) | 1;

		lowerValues[1] = /*uint*/(this.m_quantizationFactor.y * (minVertexY - this.m_worldAABB.minVertex.y)) & (box2d.b2Settings.USHRT_MAX - 1);
	...
	TestOverlapValidate: function(p1, p2){
		...
		for (var axis = 0; axis < 2; ++axis)
		{
			...
			//box2d.b2Settings.b2Assert(p1.lowerBounds[axis] < 2 * this.m_proxyCount);
			//box2d.b2Settings.b2Assert(p1.upperBounds[axis] < 2 * this.m_proxyCount);
			//box2d.b2Settings.b2Assert(p2.lowerBounds[axis] < 2 * this.m_proxyCount);
			//box2d.b2Settings.b2Assert(p2.upperBounds[axis] < 2 * this.m_proxyCount);
	...
	TestOverlap: function(b, p)
	{
		for (var axis = 0; axis < 2; ++axis)
		{
			...
			//box2d.b2Settings.b2Assert(p.lowerBounds[axis] < 2 * this.m_proxyCount);
			//box2d.b2Settings.b2Assert(p.upperBounds[axis] < 2 * this.m_proxyCount);
	...
	IncrementTimeStamp: function(){
		if (this.m_timeStamp == box2d.b2Settings.USHRT_MAX)
		{
			for (var i = 0; i < box2d.b2Settings.b2_maxProxies; ++i)
			{
...
//public:
	...
	m_proxyPool: new Array(box2d.b2Settings.b2_maxPairs),
	m_freeProxy: 0,

	m_bounds: new Array(2*box2d.b2Settings.b2_maxProxies),

	m_queryResults: new Array(box2d.b2Settings.b2_maxProxies),
...
b2BroadPhase.b2_invalid = box2d.b2Settings.USHRT_MAX;
b2BroadPhase.b2_nullEdge = box2d.b2Settings.USHRT_MAX;
...
b2Collision.EdgeSeparation = function(poly1, edge1, poly2)
	{
		...
		//box2d.b2Settings.b2Assert(edge1 < poly1.m_vertexCount);
...
b2Collision.b2CollidePoly = function(manifold, polyA, polyB, conservative)
	{
		...
		var pointCount = 0;
		for (var i = 0; i < box2d.b2Settings.b2_maxManifoldPoints; ++i)
		{
...
b2Distance.ProcessThree = function(p1Out, p2Out, p1s, p2s, points)
	{
		...
		//box2d.b2Settings.b2Assert(sn > 0.0 || tn > 0.0);
		//box2d.b2Settings.b2Assert(sd > 0.0 || un > 0.0);
		...
		//box2d.b2Settings.b2Assert(vc > 0.0 || sn > 0.0 || sd > 0.0);
		...
		{
			//box2d.b2Settings.b2Assert(un + ud > 0.0);
		...
		{
			//box2d.b2Settings.b2Assert(tn + td > 0.0);
		...
		var denom = va + vb + vc;
		//box2d.b2Settings.b2Assert(denom > 0.0);
		denom = 1.0 / denom;
		//float32 u = va * denom;
		var u = va * denom;
		//float32 v = vb * denom;
...
{
	initialize: function(){
		this.points = new Array(box2d.b2Settings.b2_maxManifoldPoints);
		for (var i = 0; i < box2d.b2Settings.b2_maxManifoldPoints; i++){
...
b2Shape.PolyMass = function(massData, vs, count, rho)
	{
		//box2d.b2Settings.b2Assert(count >= 3);
		...
		// Center of mass
		//box2d.b2Settings.b2Assert(area > Number.MIN_VALUE);
...
b2ShapeDef.prototype = 
{
	...
	ComputeMass: function(massData)
	{
		...
		case b2Shape.e_circleShape:
			{
				var circle = this;
				massData.mass = this.density * box2d.b2Settings.b2_pi * circle.radius * circle.radius;
				massData.center.Set(0.0, 0.0);
...
Object.extend(b2CircleShape.prototype, 
{
	...
	initialize: function(def, body, localCenter){
		...
		//box2d.b2Settings.b2Assert(def.type == b2Shape.e_circleShape);
		var circle = def;
...
Object.extend(b2PolyDef.prototype, 
{
	initialize: function()
	{
		...
		// initialize instance variables for references
		this.vertices = new Array(box2d.b2Settings.b2_maxPolyVertices);
		//

		this.type = b2Shape.e_polyShape;
		this.vertexCount = 0;

		for (var i = 0; i < box2d.b2Settings.b2_maxPolyVertices; i++){
			this.vertices[i] = new b2Vec2();
		}
	},

	vertices: new Array(box2d.b2Settings.b2_maxPolyVertices),
	vertexCount: 0});
...
Object.extend(b2PolyShape.prototype, 
{
	...
	initialize: function(def, body, newOrigin){
		...
		// Vertices
		this.m_vertices = new Array(box2d.b2Settings.b2_maxPolyVertices);
		this.m_coreVertices = new Array(box2d.b2Settings.b2_maxPolyVertices);
		//for (i = 0; i < box2d.b2Settings.b2_maxPolyVertices; i++)
		//	this.m_vertices[i] = new b2Vec2();

		// Normals
		this.m_normals = new Array(box2d.b2Settings.b2_maxPolyVertices);
		//for (i = 0; i < box2d.b2Settings.b2_maxPolyVertices; i++)
		//	this.m_normals[i] = new b2Vec2();

		//box2d.b2Settings.b2Assert(def.type == b2Shape.e_boxShape || def.type == b2Shape.e_polyShape);
		...
		if (def.type == b2Shape.e_boxShape)
		{
			...
			var hcX = Math.max(0.0, hX - 2.0 * box2d.b2Settings.b2_linearSlop);
			//hc.y = b2Max(0.0f, h.y - 2.0f * b2_linearSlop);
			var hcY = Math.max(0.0, hY - 2.0 * box2d.b2Settings.b2_linearSlop);
		...
		else
		{
			...
			//box2d.b2Settings.b2Assert(3 <= this.m_vertexCount && this.m_vertexCount <= box2d.b2Settings.b2_maxPolyVertices);
			...
			for (i = 0; i < this.m_vertexCount; ++i)
			{
				...
				this.m_coreVertices[i].x = this.m_vertices[i].x - 2.0 * box2d.b2Settings.b2_linearSlop * uX;
				this.m_coreVertices[i].y = this.m_vertices[i].y - 2.0 * box2d.b2Settings.b2_linearSlop * uY;
			}
		...
		for (i = 0; i < this.m_vertexCount; ++i)
		{
			...
			//box2d.b2Settings.b2Assert(b2Math.b2CrossVV(this.m_normals[i1], this.m_normals[i2]) > Number.MIN_VALUE);
		}
...
b2Body.prototype = 
{
	...
	initialize: function(bd, world){
		...
		var massDatas = new Array(box2d.b2Settings.b2_maxShapesPerBody);
		for (i = 0; i < box2d.b2Settings.b2_maxShapesPerBody; i++){
...
b2BodyDef.prototype = 
{
	initialize: function()
	{
		...
		this.userData = null;
		for (var i = 0; i < box2d.b2Settings.b2_maxShapesPerBody; i++){
			this.shapes[i] = null;
		}
...
b2Island.prototype = 
{
	...
	Solve: function(step, gravity)
	{
		...
		if (b2World.s_enablePositionCorrection)
		{
			...
			{
				var contactsOkay = contactSolver.SolvePositionConstraints(box2d.b2Settings.b2_contactBaumgarte);
	...
	UpdateSleep: function(dt)
	{
		...
		var linTolSqr = box2d.b2Settings.b2_linearSleepTolerance * box2d.b2Settings.b2_linearSleepTolerance;
		var angTolSqr = box2d.b2Settings.b2_angularSleepTolerance * box2d.b2Settings.b2_angularSleepTolerance;
		...
		if (minSleepTime >= box2d.b2Settings.b2_timeToSleep)
		{
			for (i = 0; i < this.m_bodyCount; ++i)
			{
				b = this.m_bodies[i];
	...
	{
		//box2d.b2Settings.b2Assert(this.m_bodyCount < this.m_bodyCapacity);
		this.m_bodies[this.m_bodyCount++] = body;
	},

	AddContact: function(contact)
	{
		//box2d.b2Settings.b2Assert(this.m_contactCount < this.m_contactCapacity);
		this.m_contacts[this.m_contactCount++] = contact;
	},

	AddJoint: function(joint)
	{
		//box2d.b2Settings.b2Assert(this.m_jointCount < this.m_jointCapacity);
...
b2Contact.AddType = function(createFcn, destroyFcn, type1, type2)
	{
		//box2d.b2Settings.b2Assert(b2Shape.e_unknownShape < type1 && type1 < b2Shape.e_shapeTypeCount);
		//box2d.b2Settings.b2Assert(b2Shape.e_unknownShape < type2 && type2 < b2Shape.e_shapeTypeCount);
...
b2Contact.Destroy = function(contact, allocator){
		//box2d.b2Settings.b2Assert(b2Contact.s_initialized == true);
	...
	initialize: function(contacts, contactCount, allocator){
		...
		for (i = 0; i < contactCount; ++i)
		{
			...
			for (var j = 0; j < manifoldCount; ++j)
			{
				...
				//box2d.b2Settings.b2Assert(manifold.pointCount > 0);

				//var normal = manifold.normal.Copy();
				var normalX = manifold.normal.x;
				var normalY = manifold.normal.y;

				//box2d.b2Settings.b2Assert(count < this.m_constraintCount);
				...
				for (var k = 0; k < c.pointCount; ++k)
				{
					...
					//box2d.b2Settings.b2Assert(kNormal > Number.MIN_VALUE);
					...
					//box2d.b2Settings.b2Assert(kTangent > Number.MIN_VALUE);
					...
					if (vRel < -box2d.b2Settings.b2_velocityThreshold)
					{
	...
	SolvePositionConstraints: function(beta){
		...
		for (var i = 0; i < this.m_constraintCount; ++i)
		{
			...
			for (var j = 0; j < tCount; ++j)
			{
				...
				var C = beta * b2Math.b2Clamp(separation + box2d.b2Settings.b2_linearSlop, -box2d.b2Settings.b2_maxLinearCorrection, 0.0);
		...
		return minSeparation >= -box2d.b2Settings.b2_linearSlop;
	},
	PostSolve: function(){
		for (var i = 0; i < this.m_constraintCount; ++i)
		{
...
Object.extend(b2CircleContact.prototype, 
{
		...
		//box2d.b2Settings.b2Assert(this.m_shape1.m_type == b2Shape.e_circleShape);
		//box2d.b2Settings.b2Assert(this.m_shape2.m_type == b2Shape.e_circleShape);
...
b2Conservative.Conservative = function(shape1, shape2){
		...
		for (var iter = 0; iter < maxIterations; ++iter)
		{
			...
			if (distance < box2d.b2Settings.b2_linearSlop)
			{
				if (iter == 0)
				{
					hit = false;
...
Object.extend(b2PolyAndCircleContact.prototype, {
		...
		box2d.b2Settings.b2Assert(this.m_shape1.m_type == b2Shape.e_polyShape);
		box2d.b2Settings.b2Assert(this.m_shape2.m_type == b2Shape.e_circleShape);
		this.m_manifold[0].pointCount = 0;
		this.m_manifold[0].points[0].normalImpulse = 0.0;
		this.m_manifold[0].points[0].tangentImpulse = 0.0;
...
Object.extend(b2PolyContact.prototype, 
{
		...
		//super(shape1, shape2);
		//box2d.b2Settings.b2Assert(this.m_shape1.m_type == b2Shape.e_polyShape);
		//box2d.b2Settings.b2Assert(this.m_shape2.m_type == b2Shape.e_polyShape);
		this.m_manifold[0].pointCount = 0;
	},
	//~b2PolyContact() {}
...
Object.extend(b2ContactManager.prototype, 
{
	...
	PairAdded: function(proxyUserData1, proxyUserData2){
		...
		else
		{
			...
			if (this.m_contactSubscriber) {
				try {
					this.m_contactSubscriber.startContact(body1, body2, shape1, shape2);	
				}
				catch (e) {
					console.debug("error calling start contact subscriber:", e);
				}
			}
		}
	...
	PairRemoved: function(proxyUserData1, proxyUserData2, pairUserData){
		...
		{
			//box2d.b2Settings.b2Assert(this.m_world.m_contactCount > 0);
		...
		if (this.m_contactSubscriber) {
			try {
				this.m_contactSubscriber.endContact(proxyUserData1.m_body, proxyUserData2.m_body, proxyUserData1, proxyUserData2);	
			}
			catch (e) {
				console.debug("error calling end contact subscriber:", e);
			}
		}
	},
	...
	Collide: function()
	{
		...
		for (var c = this.m_world.m_contactList; c != null; c = c.m_next)
		{
			...
			{
				//box2d.b2Settings.b2Assert(c.GetManifolds().pointCount > 0);
...
b2World.prototype = 
{
	...
	DestroyBody: function(b)
	{
		...
		//box2d.b2Settings.b2Assert(this.m_bodyCount > 0);
		--this.m_bodyCount;
	...
	CleanBodyList: function()
	{
		...
		while (b)
		{
			//box2d.b2Settings.b2Assert((b.m_flags & b2Body.e_destroyFlag) != 0);
	...
	DestroyJoint: function(j)
	{
		...
		//box2d.b2Settings.b2Assert(this.m_jointCount > 0);
		--this.m_jointCount;
		...
		for (var seed = this.m_bodyList; seed != null; seed = seed.m_next)
		{
			...
			while (stackCount > 0)
			{
				...
				for (var cn = b.m_contactList; cn != null; cn = cn.next)
				{
					...
					//box2d.b2Settings.b2Assert(stackCount < stackSize);
...
Object.extend(b2DistanceJoint.prototype, 
{
	...
	PrepareVelocitySolver: function(){
		...
		if (length > box2d.b2Settings.b2_linearSlop)
		{
			//this.m_u *= 1.0 / length;
		...
		this.m_mass = this.m_body1.m_invMass + this.m_body1.m_invI * cr1u * cr1u + this.m_body2.m_invMass + this.m_body2.m_invI * cr2u * cr2u;
		//box2d.b2Settings.b2Assert(this.m_mass > Number.MIN_VALUE);
	...
	SolvePositionConstraints: function(){
		...
		C = b2Math.b2Clamp(C, -box2d.b2Settings.b2_maxLinearCorrection, box2d.b2Settings.b2_maxLinearCorrection);
		...
		return b2Math.b2Abs(C) < box2d.b2Settings.b2_linearSlop;
...
Object.extend(b2GearJoint.prototype, 
{
	...
	initialize: function(def){
		...
		//box2d.b2Settings.b2Assert(def.joint1.m_type == b2Joint.e_revoluteJoint || def.joint1.m_type == b2Joint.e_prismaticJoint);
		//box2d.b2Settings.b2Assert(def.joint2.m_type == b2Joint.e_revoluteJoint || def.joint2.m_type == b2Joint.e_prismaticJoint);
		//box2d.b2Settings.b2Assert(def.joint1.m_body1.IsStatic());
		//box2d.b2Settings.b2Assert(def.joint2.m_body1.IsStatic());
	...
	PrepareVelocitySolver: function(){
		...
		//box2d.b2Settings.b2Assert(K > 0.0);
		this.m_mass = 1.0 / K;
	...
	SolvePositionConstraints: function(){
		...
		return linearError < box2d.b2Settings.b2_linearSlop;
	},
...
Object.extend(b2MouseJoint.prototype, 
{
	...
	initialize: function(def){
		...
		// Frequency
		var omega = 2.0 * box2d.b2Settings.b2_pi * def.frequencyHz;
...
Object.extend(b2PrismaticJoint.prototype, 
{
	...
	PrepareVelocitySolver: function(){
		...
		//box2d.b2Settings.b2Assert(this.m_linearMass > Number.MIN_VALUE);
		...
		if (this.m_enableLimit || this.m_enableMotor)
		{
			...
			//box2d.b2Settings.b2Assert(this.m_motorMass > Number.MIN_VALUE);
			...
			if (this.m_enableLimit)
			{
				...
				if (b2Math.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2.0 * box2d.b2Settings.b2_linearSlop)
				{
	...
	SolvePositionConstraints: function(){
		...
		linearC = b2Math.b2Clamp(linearC, -box2d.b2Settings.b2_maxLinearCorrection, box2d.b2Settings.b2_maxLinearCorrection);
		...
		// Prevent overly large corrections.
		angularC = b2Math.b2Clamp(angularC, -box2d.b2Settings.b2_maxAngularCorrection, box2d.b2Settings.b2_maxAngularCorrection);
		...
		if (this.m_enableLimit && this.m_limitState != b2Joint.e_inactiveLimit)
		{
			...
			if (this.m_limitState == b2Joint.e_equalLimits)
			{
				...
				limitC = b2Math.b2Clamp(translation, -box2d.b2Settings.b2_maxLinearCorrection, box2d.b2Settings.b2_maxLinearCorrection);
			...
			else if (this.m_limitState == b2Joint.e_atLowerLimit)
			{
				...
				limitC = b2Math.b2Clamp(limitC + box2d.b2Settings.b2_linearSlop, -box2d.b2Settings.b2_maxLinearCorrection, 0.0);
				limitImpulse = -this.m_motorMass * limitC;
			...
			else if (this.m_limitState == b2Joint.e_atUpperLimit)
			{
				...
				// Prevent large linear corrections and allow some slop.
				limitC = b2Math.b2Clamp(limitC - box2d.b2Settings.b2_linearSlop, 0.0, box2d.b2Settings.b2_maxLinearCorrection);
				limitImpulse = -this.m_motorMass * limitC;
				oldLimitImpulse = this.m_limitPositionImpulse;
		...
		return positionError <= box2d.b2Settings.b2_linearSlop && angularError <= box2d.b2Settings.b2_angularSlop;
...
Object.extend(b2PulleyJoint.prototype, 
{
	...
	PrepareVelocitySolver: function(){
		...
		if (length1 > box2d.b2Settings.b2_linearSlop)
		{
		...
		if (length2 > box2d.b2Settings.b2_linearSlop)
		{
		...
		//box2d.b2Settings.b2Assert(this.m_limitMass1 > Number.MIN_VALUE);
		//box2d.b2Settings.b2Assert(this.m_limitMass2 > Number.MIN_VALUE);
		//box2d.b2Settings.b2Assert(this.m_pulleyMass > Number.MIN_VALUE);
	...
	SolvePositionConstraints: function(){
		...
		if (this.m_limitState1 == b2Joint.e_atUpperLimit)
		{
			...
			C = b2Math.b2Clamp(C + box2d.b2Settings.b2_linearSlop, -box2d.b2Settings.b2_maxLinearCorrection, 0.0);
...
b2PulleyJoint.b2_minPulleyLength = box2d.b2Settings.b2_lengthUnitsPerMeter;
...
Object.extend(b2RevoluteJoint.prototype, 
{
	...
	PrepareVelocitySolver: function(){
		...
		if (this.m_enableLimit)
		{
			...
			if (b2Math.b2Abs(this.m_upperAngle - this.m_lowerAngle) < 2.0 * box2d.b2Settings.b2_angularSlop)
			{
				this.m_limitState = b2Joint.e_equalLimits;
			}
	...
	SolvePositionConstraints: function(){
		...
		if (this.m_enableLimit && this.m_limitState != b2Joint.e_inactiveLimit)
		{
			...
			{
				// Prevent large angular corrections
				limitC = b2Math.b2Clamp(angle, -box2d.b2Settings.b2_maxAngularCorrection, box2d.b2Settings.b2_maxAngularCorrection);
				limitImpulse = -this.m_motorMass * limitC;
			...
			else if (this.m_limitState == b2Joint.e_atLowerLimit)
			{
				...
				limitC = b2Math.b2Clamp(limitC + box2d.b2Settings.b2_angularSlop, -box2d.b2Settings.b2_maxAngularCorrection, 0.0);
				limitImpulse = -this.m_motorMass * limitC;
				oldLimitImpulse = this.m_limitPositionImpulse;
				this.m_limitPositionImpulse = b2Math.b2Max(this.m_limitPositionImpulse + limitImpulse, 0.0);
				limitImpulse = this.m_limitPositionImpulse - oldLimitImpulse;
			...
			else if (this.m_limitState == b2Joint.e_atUpperLimit)
			{
				...
				// Prevent large angular corrections and allow some slop.
				limitC = b2Math.b2Clamp(limitC - box2d.b2Settings.b2_angularSlop, 0.0, box2d.b2Settings.b2_maxAngularCorrection);
				limitImpulse = -this.m_motorMass * limitC;
				oldLimitImpulse = this.m_limitPositionImpulse;
				this.m_limitPositionImpulse = b2Math.b2Min(this.m_limitPositionImpulse + limitImpulse, 0.0);
				limitImpulse = this.m_limitPositionImpulse - oldLimitImpulse;
