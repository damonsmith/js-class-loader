...
public class Paths implements Iterable<String> {
	...
	/**
	 * Creates a Paths object and calls {@link #glob(String, java.util.List)} with the specified arguments.
	 */
	...
	static private void copyFile (File in, File out) throws IOException {
		...
		FileOutputStream destOut = new FileOutputStream(out);
		FileChannel destinationChannel = destOut.getChannel();
